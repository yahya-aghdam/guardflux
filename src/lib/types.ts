...
export interface DbConfig {
    ...
    dbType: DBType;   // Required field to specify the type of database being used (e.g., PostgreSQL, MySQL, MongoDB, Redis).
    ...
    // Optional prefix for Redis keys (only used when dbType is 'redis')
    redisPrefix?: string;
}
